...
trait Workflowable
{
   ...
   * @throws \Exception
   */
  public function nextTransitionsWithConfigurations()
  {
    return $this->workflowInstance()->getConfigsForPossibleTransitions();
  }
  ...
  {
    return $this->morphMany(WorkflowHistory::class, 'historyable', 'model_name', 'model_id');
